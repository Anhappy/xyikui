...
package com.an.happy.mvprxjava.data.source.local;
...
import com.an.happy.mvprxjava.data.source.local.TasksPersistenceContract.TaskEntry;
...
public class TasksLocalDataSource implements TasksDataSource {
    ...
    public void saveTask(@NonNull Task task) {
        Log.d("t_log","DEBUG ---come TasksLocalDataSource saveTask 3");
        checkNotNull(task);
